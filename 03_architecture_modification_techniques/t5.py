...
def initialize_model(num_classes=7):
    ...
    for block in model.blocks:
        block.mlp.drop = nn.Dropout(0.3)  # Increase MLP Dropout
        block.attn_drop = nn.Dropout(0.3)  # Increase Attention Dropout
...
final_results_df.to_csv('./t5.csv', index=False)

print("Predictions with metadata saved to './t5.csv'")
