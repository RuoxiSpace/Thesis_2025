...
# Model setup
def initialize_model(num_classes=7, patch_size=32):
    # Load the base model and modify the patch size from 16 to 32
...
for run in range(num_runs):
    ...
    model = initialize_model(num_classes=7, patch_size=32)
...
final_results_df.to_csv('./t1.csv', index=False)

print("Predictions with metadata saved to './t1.csv'")
