...
def initialize_model(num_classes=7):
    ...
    # Modify the Transformer Encoder with 4 layers
    model.blocks = model.blocks[:4]  # Keep only the first 4 layers
...
final_results_df.to_csv('./s5.csv', index=False)

print("Predictions with metadata saved to './s5.csv'")
