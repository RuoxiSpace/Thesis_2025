...
class RAFDBDataset(Dataset):
    ...
    def _is_minority_group(self, row):
        # Adjust the condition for minority group
        return (
...
for run in range(num_runs):
    ...
    train_dataset = RAFDBDataset(
        ...
        transform=general_transform, advanced_transform=advanced_transform
    )
...
final_results_df.to_csv('./vit_aug_under.csv', index=False)

print("Predictions with metadata for all datasets saved to './vit_aug_under.csv'")
